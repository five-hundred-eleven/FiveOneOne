...
class test_vector(unittest.TestCase):
    ...
    def assertVectorEqual(self, v1, v2):
        ...
        for m, n in zip(v1, v2):
            self.assertEqual(float(m), float(n))

    def vectorize(self, v):
    ...
    def test_index_multi_values(self):
        l = self.vectorize([1, 3, 1, 3, 1, 3])
        v = Vector(l)
        self.assertEqual(l.index(3.), v.index(3.))

    def test_slice_3_6_1(self):
        l = self.vectorize(range(100))
        v = Vector(l)
        i, j = 3, 6
        self.assertVectorEqual(l[i:j], v[i:j])
    ...
    def test_slice_neg_60_60_2(self):
        ...
        v = Vector(l)
        i, j, k = -60, 60, 2
        self.assertVectorEqual(l[i:j:k], v[i:j:k])
    ...
    def test_slice_None_None_3(self):
        ...
        v = Vector(l)
        k = 3
        self.assertVectorEqual(l[::k], v[::k])
    ...
    def test_slice_full_reverse(self):
        l = self.vectorize(range(100))
        v = Vector(l)
        self.assertVectorEqual(l[::-1], v[::-1])
